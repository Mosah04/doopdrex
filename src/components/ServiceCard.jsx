  ...
  return (
    <div className="relative w-[400px] justify-items-center aspect-[4/3] rounded-xl border border-secondary/30 hover:border-tertiary/30 transition-colors duration-500 group">
      <Image
        ...
        src={imgURL}
      />
      <div className="absolute rounded-b-[inherit] left-0 bottom-0 w-full bg-gradient-to-b from-transparent to-accent group-hover:bg-secondary/50 transition-all duration-300 p-2">
